...
return [
  ...
  'hashmatch' => 'The :attribute must match your account password.',
  'country' => 'The :attribute is invalid.',
  'state' => 'The :attribute is invalid.',
  'state_id' => ' The selected state is invalid.',
  'city' => 'The :attribute is invalid.',
  'city_id' => ' The selected city is invalid.',
  'custom' => [
    'emailReset' => [
      'exists' => 'L\'e-mail n\'existe pas',
    ],
  ],
  /*
    |--------------------------------------------------------------------------
