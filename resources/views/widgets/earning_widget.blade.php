        ...
        <div class="earning-report">
          <div class="report-header">
            ...
            <div class="col-sm-4 report-cell report-cell-dark">
              <span class="fleft">@lang('messages.earnings') <i class="fa fa-bar-chart pull-right"></i></span>
            ...
            <div class="row" ng-show="earnings.length > 0" ng-repeat="(key, earning) in earnings">
              <div class="col-sm-12">
                ...
                <div class="col-sm-2 report-cell">
                  <span><a ng-click="showDayDetail(key, earning.datetime)" class="btn btn-link"><span ng-show="!earning.details">@lang('messages.showDetail')</span><span ng-show="earning.details">@lang('messages.lessDetail')</span></a></span>
                </div>
              </div>
          ...
          <div class="earning-content">
            <div class="row" ng-show="earnings.length > 0" ng-repeat="(key, earning) in earnings">
              <div class="col-sm-12">
                ...
                <div class="col-sm-2 report-cell">
                  <span><a ng-click="showNoneDetail(key, earning.id)"><span ng-show="!earning.detail">@lang('messages.showDetail')</span><span ng-show="earning.detail">@lang('messages.lessDetail')</span></a></span>
                </div>
              </div>
              <div class="col-sm-12">
