  ...
  <div class="row">
    <div class="col-sm-4 col-md-2">
      ...
      <ul class="menu-message">
        ...
        <li><a class="<?php echo ($_GET && isset($_GET['tab']) && $_GET['tab'] == 'inbox') ? 'active' : '';?>" href="{{URL($routing.'/messages')}}">@lang('messages.inbox')</a></li>
        <li> <a class="<?php echo ($_GET && isset($_GET['tab']) && $_GET['tab'] == 'sent') ? 'active' : '';?>" href="{{URL($routing.'/messages/sent')}}">@lang('messages.sent')</a></li>
        <li> <a class="<?php echo ($_GET && isset($_GET['tab']) && $_GET['tab'] == 'trash') ? 'active' : '';?>" href="{{URL($routing.'/messages/trash')}}">@lang('messages.trash')</a></li>
      </ul>   
    </div>
            ...
            <div class="item to">
              <form method="post" action="{{URL($routing.'/messages/private-thread&thread_id=')}}{{$threadId}}"  id="new_message_form">
                ...
                <div class="message-input">
                  ...
                  <button type="submit" class="btn btn-lg btn-danger">@lang('messages.send')</button>
                </div>
              </form>
            </div>
          </div>
