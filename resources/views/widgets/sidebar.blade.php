                        ...
                        <div class="sidebar-menu">
                            <ul id="menu-content" class="menu-content collapse out">
                                ...
                                <ul class="sub-menu collapse in" id="807765384d9d5527da8848df14a4f02f" class="menu-section-items-links">
                                    ...
                                    <a class="menu-section-item-a-friends" href="{{URL('dashboard/u/'.$userLogin->username.'/friends')}}"><li class="menu-section-item-friends">@lang('messages.Amigos')</li></a>
                                    <a class="menu-section-item-a-photos" href="{{URL('dashboard/u/'.$userLogin->username.'/photos')}}"><li class="menu-section-item-photos">@lang('messages.Fotos')</li></a>
...
<form method="get" action="{{URL('dashboard/search')}}">
      ...
      <input type="submit" class="btn btn-primary" name="submit" value="buscar" style="width: 94%;padding: 3%;margin-left: 3%;">
               ...
               <div class="row wrap-banner-home  visible-xs visible-sm" style="    ">
                    ...
                    <?php $data = app('settings'); ?>
                    <div class="col-md-6 item">
                        <?php echo ($data->BannerHomeUnoLink != "" ? "<a href='".$data->BannerHomeUnoLink."'  >" : ''); ?> 
                   
                                
                            <?php echo ($data->BannerHomeUno != "" ? "<img src='".URL($data->BannerHomeUno)."'  class='img-responsive'>" : ''); ?> 
                    ...
                    <div class="col-md-6 item">
                        <?php echo ($data->BannerHomeDosLink != "" ? "<a href='".$data->BannerHomeDosLink."'  >" : ''); ?> 
                            ...
                            <?php echo ($data->BannerHomeDos != "" ? "<img src='".URL($data->BannerHomeDos)."'  class='img-responsive'>" : ''); ?> 
                    ...
                    <div class="col-md-6 item">
                        <?php echo ($data->BannerHomeTresLink != "" ? "<a href='".$data->BannerHomeTresLink."'  >" : ''); ?> 
                            ...
                            <?php echo ($data->BannerHomeTres!= "" ? "<img src='".URL($data->BannerHomeTres)."'  class='img-responsive' >" : ''); ?> 
                    ...
                    <div class="col-md-6 item">
                        <?php echo ($data->BannerHomeCuatroLink != "" ? "<a href='".$data->BannerHomeCuatroLink."'  >" : ''); ?> 
                            ...
                            <?php echo ($data->BannerHomeCuatro!= "" ? "<img src='".URL($data->BannerHomeCuatro)."'  class='img-responsive' >" : ''); ?> 
                    ...
                    <div class="col-md-6 item">
                        <?php echo ($data->BannerHomeCincoLink != "" ? "<a href='".$data->BannerHomeCincoLink."'  >" : ''); ?> 
                            ...
                            <?php echo ($data->BannerHomeCinco!= "" ? "<img src='".URL($data->BannerHomeCinco)."'  class='img-responsive' >" : ''); ?> 
                    ...
                    <div class="col-md-6 item">
                        <?php echo ($data->BannerHomeSeisLink != "" ? "<a href='".$data->BannerHomeSeisLink."'  >" : ''); ?> 
                            ...
                            <?php echo ($data->BannerHomeSeis!= "" ? "<img src='".URL($data->BannerHomeSeis)."'  class='img-responsive' >" : ''); ?> 
                    ...
                    <div class="col-md-6 item">
                        <?php echo ($data->BannerHomeSieteLink != "" ? "<a href='".$data->BannerHomeSieteLink."'  >" : ''); ?> 
                            ...
                            <?php echo ($data->BannerHomeSiete!= "" ? "<img src='".URL($data->BannerHomeSiete)."'  class='img-responsive' >" : ''); ?> 
                    ...
                    <div class="col-md-6 item">
                        <?php echo ($data->BannerHomeOchoLink != "" ? "<a href='".$data->BannerHomeOchoLink."'  >" : ''); ?> 
                            ...
                            <?php echo ($data->BannerHomeOcho!= "" ? "<img src='".URL($data->BannerHomeOcho)."'  class='img-responsive' >" : ''); ?> 
