      ...
      <!-- content   -->
                                    ...
                                    <div class="row ossn-page-contents">
                                       <div class="col-md-6 home-left-contents">
                                         ...
                                         <ul class = "text-descrption-home">
                                                 <li>Le plus grand réseau social avec webcam </li>
                                                 <li>Discutez avec vos amis et réalisez vos envies érotiques, seul, en couple ou en groupe. </li>
                                                 <li>La communauté est respectueuse et amusante. </li>
                                                 <li>Partagez des photos, des vidéos et diffusez en direct. </li>
                                                 <li>Rejoignez-nous et adoptez un style de vie différent. </li>
                                           </ul>
                                       </div>
                                       <div class="col-md-6">
       ...
       title="porfavor introduce un  nick valido" required="required" name="username" style="width: 100%">
                   ...
                   <div class="col-md-6">
                        ...
                        <p></p>
                       <a href="{{URL('pag/fr/strategies')}}" target="_blank" class="txtUnderL colorTheme">@lang('messages.conditiondos')</a>  @lang('messages.and') 
                        <a href="{{URL('pag/fr/politique-de-cookies')}}" class="txtUnderL colorTheme">@lang('messages.cuantoalascookies')</a>.
      ...
      <footer class="text-center">
         ...
         <div class="col-md-12" style="background: black; color: white; padding: 10px;">
            <ul class="estiloul" style="align-items: center;
               ...
               <a class="back" href="{{ url('/') }}"> <img width="30px" height="15px" src='{{URL("images/$lang.jpg")}}'>

                  @else
                     <a class="back" href="{{ url('/', [$lang]) }}"> <img width="30px" height="15px" src='{{URL("images/$lang.jpg")}}'>
                  </a>
