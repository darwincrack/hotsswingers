      ...
      <!-- content   -->
                              ...
                              <div class="ossn-home-container">
                                 <div class="inner">
                                    <div class="row ossn-page-contents">
                                       <div class="col-md-6 home-left-contents wrap-text-descrption-home">
                                         
                                          <div class="img-home" style="width: 100%">
                                             @if(app('settings')->registerImage)

                                                 @if(app('settings')->bannerLinkHomePage)

                                                      <a href="{{app('settings')->bannerLinkHomePage}}">
                                                            <img src="/{{app('settings')->registerImage}}" class= "img-responsive" alt="" >
                                                      </a>
                                                 @else
                                          ...
                                          <ul class = "text-descrption-home">
                                                 <li>The largest social network with webcam </li>
                                                 <li>Chat with your friends and make your erotic desires come true, alone, as a couple or in a group. </li>
                                                 <li>The community is respectful and fun. </li>
                                                 <li>Share photos, videos and broadcast live. </li>
                                                 <li>Join us and start a different lifestyle. </li>
                                              </ul>
                                       </div>
                                       <div class="col-md-6">
         ...
         <fieldset style="display: none;" id="dos">
            <div class="row" style="margin-right: 0; margin-left: 0;">
               <div class="estilosborde col-xs-12 col-sm-12 col-md-5 col-md-offset-4 text-center">
                  <div>
         ...
         <fieldset style="display: none;" id="cuatro">
            <div class="row" style="margin-right: 0; margin-left: 0;">
               <div class="estilosborde col-xs-12 col-sm-12 col-md-6 col-md-offset-4 text-center" style="    padding: 2% 2% !important;">
                  <div>
         ...
         <fieldset style="display: none;" id="seis" data-texto="@lang('messages.traduc7')">
            <div class="row" style="margin-right: 0; margin-left: 0;">
               <div class="estilosborde col-xs-12 col-sm-12 col-md-5 col-md-offset-4 text-center" style="    padding: 2% 2% !important;">
                  <div>
       ...
       title="porfavor introduce un  nick valido" required="required" name="username" style="width: 100%">
                     ...
                     <div class="col-md-6" style="margin: 5px 0;">
                        ...
                        <input class="w100 validaresto4 form-control" maxlength="30" type="password" style="width: 100%; cursor: auto;" required="required" name="password" id="clave1">
                     ...
                     <div class="col-md-6" style="margin: 5px 0;">
                        ...
                        <input class="w100 validaresto4 form-control" maxlength="30" type="password" style="width: 100%;  cursor: auto;" required="required" name="password_confirmation" id="clave2">
                     ...
                     <div class="col-md-6">
                        ...
                        <a href="{{URL('pag/politica-de-privacidad')}}" target="_blank" class="txtUnderL colorTheme">@lang('messages.1303') </a> 
                        <p></p>
                       <a href="{{URL('pag/en/policies')}}" target="_blank" class="txtUnderL colorTheme">@lang('messages.conditiondos')</a>  @lang('messages.and') 
                        <a href="{{URL('pag/en/cookies-policy')}}" class="txtUnderL colorTheme">@lang('messages.cuantoalascookies')</a>.
         ...
         <div class="col-md-12" style="background: black; color: white; padding: 10px;">
            <ul class="estiloul" style="align-items: center;
              ...
              @if ($lang == 'es')
               ...
               <a class="backkk" href="{{ url('/') }}"> <img width="30px" height="15px" src='{{URL("images/$lang.jpg")}}'>

                  @else
                     <a class="backeeee" href="{{ url('/', [$lang]) }}"> <img width="30px" height="15px" src='{{URL("images/$lang.jpg")}}'>
                  </a>
