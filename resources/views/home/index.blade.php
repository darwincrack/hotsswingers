   ...
   <body>
      ...
      <!-- content   -->
                                 ...
                                 <div class="inner">
                                    <div class="row ossn-page-contents">
                                          ...
                                          <div class="img-home" style="width: 100%">
                                             ...
                                             @endif
                                       		...
                                       		<ul class="text-descrption-home">
                                       			<li>La mayor red social con webcam</li>
                                       			<li>Chatea con tus amigos y haz realidad tus deseos eróticos, sol@, en pareja o en grupo.</li>
                                       			<li>La comunidad es respetuosa y divertida.</li>
                                       			<li>Comparte fotos, videos y retrasmite en directo.</li>
                                       			<li>Únete a nosotros y empieza un estilo de vida diferente.</li>
                                       		</ul>
                                       ...
                                       <div class="col-md-6">
                                          ...
                                          <div class="ossn-widget" style="padding: 6%;text-align: center;">
         ...
         <fieldset style="display: none;" id="cuatro">
            <div class="row" style="margin-right: 0; margin-left: 0;">
               <div class="estilosborde col-xs-12 col-sm-12 col-md-6 col-md-offset-3 text-center" style="    padding: 2% 2% !important;">
                  <div>
       ...
       title="porfavor introduce un  nick valido" required="required" name="username" style="width: 100%">
                     ...
                     <div class="col-md-6">
                        ...
                        <p></p>
                       <a href="{{URL('pag/politicas')}}" target="_blank" class="txtUnderL colorTheme">@lang('messages.conditiondos')</a>  @lang('messages.and') 
                        <a href="{{URL('pag/politica-de-cookies')}}" class="txtUnderL colorTheme">@lang('messages.cuantoalascookies')</a>.
