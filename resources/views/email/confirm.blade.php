   ...
   <tr>
      <td style=" width: 100%" >
          <strong>@lang('messages.dear') <?=$username?>,</strong><br>
           <br>
           @lang('messages.thankyouforregistering') {{app('settings')['siteName']}}. <br>@lang('messages.inordertoverify') <span class="il"></span> (<a href="mailto:<?=$email?>" target="_blank"><?=$email?></a>) , @lang('messages.pleasefollowthe'):<br>
