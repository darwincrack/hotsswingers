    ...
    <tbody>
      <tr>
        <td style=" width: 100%" >
          ...
          <br>
          <p>@lang('messages.requestinformation') @lang('messages.yourpayoutrequest') #{{$request->id}} @lang('messages.statushasbeenupdatedto') <strong>{{$request->status}}</strong></p>
        </td>
      </tr>
      <tr>
        <td style=" width: 100%">
          ...
          <div>
            <strong>@lang('messages.note'): </strong> {!! $request->note !!}
          </div>
