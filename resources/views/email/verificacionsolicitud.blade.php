    ...
    <tbody>
      ...
      <tr>
        <td style=" width: 100%" >
          ...
          <br>
            <p>El usuario {{ $username }}, ha solicitado verificar  su cuenta.</p>

          <a style="white-space:pre-wrap" href="<?=URL('admin/manager/profile/identification/'.$user_id)?>">Link para ver los documentos enviados por el usuario</a>
          <br>
        </td>
      </tr>
