...
$(document).ready(function() {
    $("body img").on("contextmenu", function(a) {
        return !1
    });
    ...
    if ($('#datepicker-11').length) {
        $('#datepicker-11 .input-daterange').datetimepicker({
            format: 'YYYY-MM-DD',
    ...
    $('.counter-count').jQuerySimpleCounter({
        end: $(".counter-count").html(),
        duration: 3000
    });
...
function gira(){
  ...
  spin(ruletas,nivel,result){




if(nivel == 1){
data = ruletas.datos.datosniveluno;

}else if(nivel == 2){
data = ruletas.datos.datosniveldos;
    
}else if(nivel == 3){
data = ruletas.datos.datosniveltres;
    ...
    console.log("-------------------");
          ...
          return function(t) {
            ...
            if(result !==false){
                ...
                if(parseInt(picked) != result){
                    Website.spin(ruletas,nivel,result);
                    return;
...
return {"task":data[picked].task, "picked":picked};
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    dbSelect.append($('<option/>', {
                        value: "0",
                        text: "-- Seleccione ciudad (Opcional)--"
                    }));
