...
<div class="ossn-wall-item" id="activity-item-<?php echo $params['post']->guid; ?>">
	<div class="row">
		<div class="meta">
			<img class="user-img" src="<?php echo ossn_getimagenes($params['user']->id,'small'); ?>" />
			<div class="post-menu">
				<div class="dropdown">
                 <?php
           ...
           <?php if ($params['user']->guid == $params['post']->owner_guid) { ?>
                <a class="owner-link" href="<?php echo $params['user']->profileURL(); ?>"> <?php echo $params['user']->username; ?> </a>
            ...
            <?Php
                ...
                <a href="<?php echo $owner->profileURL(); ?>"> <?php echo $owner->username; ?></a>
            <?php } ?>
			</div>
			<div class="post-meta">
