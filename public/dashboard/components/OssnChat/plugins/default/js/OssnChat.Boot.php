...
if(OssnChat['allfriends']){
	$.each(OssnChat['allfriends'], function(key, data){
			...
			/* build initial list */
			var appendata = '<div data-toggle="tooltip" title="'+data['name']+'" class="friends-list-item" id="friend-list-item-'+data['guid']+'" onClick="Ossn.ChatnewTab('+data['guid']+');"><div class="friends-item-inner '+data['guid']+'"><div class="icon"><img class="ustatus '+data['status']+'" src="'+data['icon']+'" /></div></div></div>';    
