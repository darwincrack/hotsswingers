		...
		if($.isFunction($.fn.tokenInput)){
			$("#ossn-wall-friend-input").tokenInput(Ossn.site_url + "friendpicker", {
				...
				resultsFormatter: function(item){
					return "<li>" + "<img src='" + item.imageurl + "' title='" + item.firstName + " " + item.lastName + "' height='25px' width='25px' />" + "<div style='display: inline-block; padding-left: 10px;'><div class='full_name' style='font-weight:bold;color:#2B5470;'>" + item.firstName + " " + item.lastName + "</div></div></li>"
				},
