...
%s',
	...
	'com:ossn:invite:empty:emails' => 'Agregue al menos una dirección de correo electrónico',
     ...
     'com:ossn:invite:a' => 'Comparte tu enlace de referidos con tus amigos',
	'com:ossn:invite:b' => 'Gana dinero con todos los usuarios nuevos que entren en implik-2.com desde tu enlace.',
	'com:ossn:invite:c' => 'Utiliza tus redes sociales para hacer la promoción: Instagram, Twitter, Facebook, Email, Whatsapp, foros y otros.',
	'com:ossn:invite:d' => 'copiar',
	'com:ossn:invite:e' => 'tu link de referido ha sido copiado: ',
);
