...
%s",
	...
	'php:upload_err_extension' => 'A PHP extension stopped the file upload',
     ...
     'basic:accountsettings' => 'Account Settings',
     'basic:messageswebcam' => 'Messages webcam',
     'basic:chatsettings' => 'Chat Settings',
     'basic:admindashboard' => 'Admin Dashboard',
     'basic:fundsortokens' => 'Funds /Tokens',
     'basic:myfavorites' => 'My Favorites',
     'basic:alllives' => 'All lives',
     'basic:lives' => 'Lives',
     'basic:quienestadonde' => 'Who is where',
     'site:seleccionalenguaje' => 'Select language',
     'basic:broadcast'=>'Broadcast Yourself',

     'perfil:perfil' =>'Profile',
     'perfil:sexo' =>'Sex',
     'perfil:ubicacion' =>'Location',
     'perfil:el' =>'He',
     'perfil:ella' =>'She',
     'perfil:Edad' =>'Age',
     'perfil:altura' =>'Height',
     'perfil:origenetnico' =>'Ethnic origin',
     'perfil:fisionomia' =>'Physiognomy',
     'perfil:ojos' =>'Eyes',
     'perfil:cabello' =>'Hair',
     'perfil:peso' =>'Weight',
     'perfil:vellopubico' =>'Pubic hair',
     'perfil:busto' =>'Bust',
     'perfil:gustos' =>'Likes',
     'perfil:experiencia' =>'Experience',
     'perfil:blog' =>'Blog',
     'perfil:link' =>'Link',
     'perfil:busco' =>'I search',
     'perfil:edad' =>'Age',
     'perfil:sobre' =>'On',
     'perfil:descripcion' =>'Description',

  
     'photos:imagenesventa' => 'Buy my photos',
     'photos:videosventa' => 'Buy my videos',
	 'photos:novideos' =>'no videos',
	 'basic:userchat' => 'Users chatting',
	/*
