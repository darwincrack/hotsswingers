...
$es = array(
	...
	'account:settings' => 'Configuraciones de la cuentas',
...
%s",
	...
	'php:upload_err_extension' => 'Una extensión PHP detuvo la carga del archivo',
     ...
     'basic:accountsettings' => 'Config. de la cuenta',
     'basic:messageswebcam' => 'Mensajes webcam',
     'basic:chatsettings' => 'Config. de chat',
     'basic:admindashboard' => 'Panel de admin',
     'basic:fundsortokens' => 'Fondos / Token',
     'basic:myfavorites' => 'Mis favoritos',
     'basic:alllives' => 'Todos los lives',
     'basic:lives' => 'Lives',
     'basic:quienestadonde' => 'Quien esta donde',
     'site:seleccionalenguaje' => 'Selecciona lenguaje',
     'basic:broadcast'=>'Transmite tú mismo',
     'perfil:perfil' =>'Perfil',
     'perfil:sexo' =>'Sexo',
     'perfil:ubicacion' =>'Ubicación',
     'perfil:el' =>'Él',
     'perfil:ella' =>'Ella',
     'perfil:Edad' =>'Edad',
     'perfil:altura' =>'Altura',
     'perfil:origenetnico' =>'Origen étnico',
     'perfil:fisionomia' =>'Fisionomía',
     'perfil:ojos' =>'Ojos',
     'perfil:cabello' =>'Cabello',
     'perfil:peso' =>'Peso',
     'perfil:vellopubico' =>'Vello púbico',
     'perfil:busto' =>'Busto',
     ...
     'photos:imagenesventa' => 'Compra mis fotos',
     'photos:videosventa' => 'Compra mis videos',
     'photos:novideos' =>'Sin videos',
     'basic:userchat' => 'Usuarios chateando',
     /*
