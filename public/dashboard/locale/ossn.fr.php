...
%s",
	...
	'php:upload_err_extension' => 'Une extension PHP a arrêté le téléchargement du fichier',
	     'basic:profile' => 'profil',	
     'basic:accountsettings' => 'Paramètres du compte',
     'basic:messageswebcam' => 'Messages webcam',
     'basic:chatsettings' => 'paramètres de discussion',
     'basic:admindashboard' => 'Tableau de bord d\'admin',
     'basic:fundsortokens' => 'Fonds / jeton',
     'basic:myfavorites' => 'Mes favoris',
          'basic:alllives' => 'toutes les vies',
     'basic:lives' => 'Lives',
     'basic:quienestadonde' => 'Qui est où',
     'site:seleccionalenguaje' => 'Choisir la langue',
     'basic:broadcast'=>'Diffusez-vous',

     'perfil:perfil' =>'Profil',
     'perfil:sexo' =>'Sexe',
     'perfil:ubicacion' =>'Emplacement',
     'perfil:el' =>'Il',
     'perfil:ella' =>'Elle',
     'perfil:Edad' =>'Âge',
     'perfil:altura' =>'la taille',
     'perfil:origenetnico' =>'Origine ethnique',
     'perfil:fisionomia' =>'Physionomie',
     'perfil:ojos' =>'Yeux',
     'perfil:cabello' =>'Cheveux',
     'perfil:peso' =>'Poids',
     'perfil:vellopubico' =>'Poils pubiens',
     'perfil:busto' =>'Buste',
     'perfil:gustos' =>'Aime',
     'perfil:experiencia' =>'Expérience',
     'perfil:blog' =>'Blog',
     'perfil:link' =>'Lien',

     'perfil:busco' =>'je recherche',
     'perfil:edad' =>'Âge',
     'perfil:sobre' =>'Sur',
     'perfil:descripcion' =>'La description',

      'photos:imagenesventa' => 'Achetez mes photos',
      'photos:imagenesventa' => 'Achetez mes Videos',
      'photos:novideos' 	=>'pas de vidéos',
       'basic:userchat' => 'utilisateurs en train de discuter',
  	/*
