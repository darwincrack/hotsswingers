...
<head>
    ...
    <link type="text/css" href="{{asset('lib/jqueryui/jquery-ui.css')}}" rel="stylesheet">

     <link type="text/css" href="{{asset('css/ossn-default.css')}}" rel="stylesheet">

     <link type="text/css" href="{{asset('css/custom.css')}}?v=333" rel="stylesheet">
    <script type="text/javascript" src="{{asset('lib/jquery/dist/jquery.min.js')}}"></script>
       ...
       <!-- <script src="{{asset('lib/ossn/ossn.chat.js')}}"></script> -->
        <script>
            ...
            Ossn.Config = { token: { ossn_ts: {{rand(1111111111,9999999999)}}, ossn_token: "{{ csrf_token() }}" }, cache: { last_cache: "87fd8e724", ossn_cache: "2" } };
            Ossn.Init();
  ...
  <body>
    ...
    <script src="{{ asset('app/services/games.service.js') }}"></script>
    <script src="{{ asset('app/services/multiretos.service.js') }}"></script>
    ...
    <script src="{{ asset('app/controllers/stream.controller.js') }}?v=51"></script>
    ...
    <script src="{{ asset('app/directives/chat-text.directive.js') }}"></script>
      <script src="{{ asset('app/directives/juegos.directive.js') }}"></script>
