   ...
   <body>
      ...
      <!-- content   -->
       ...
       title="porfavor introduce un  nick valido" required="required" name="username" style="width: 100%">
                     ...
                     <div class="col-md-6">
                       <a href="/policies" target="_blank" class="txtUnderL colorTheme">@lang('messages.conditiondos') </a>
                        <a href="" class="txtUnderL colorTheme">@lang('messages.cuantoalascookies')</a>.
