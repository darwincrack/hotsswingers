...
<html lang="en" ng-app="matroshkiApp">
  ...
  <body class="model">
          ...
          <?php else: ?>
            <div class="profile-top dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="dLabel">
                <li><a href="{{URL('models/dashboard/profile')}}"><i class="fa fa-user"></i> @lang('messages.profile')</a></li>
    ...
    @yield('content')
    <!-- content end-->
    <welcome-popup in-room="{{isset($inRoom) ? true : false}}"></welcome-popup>
    <div class="footer">
      <div class="full-container">
        @foreach( app('pages') as $page )
        <a href="{{URL('page/'.$page->alias)}}">{{$page->title}}</a>
        @endforeach
        <a href="{{URL('register?type=model')}}">Model Sign up</a>
