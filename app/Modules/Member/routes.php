...
Route::get('auth/login', function () {
  ...
  Route::get('members/promocion', 'MemberController@Promocion');
  ...
  Route::get('paymenterror', 'MemberController@getPaymentError');
  Route::get('paymentsucess', 'MemberController@getPaymentSuccess');
  Route::post('paymentresult', 'MemberController@getPaymentResult');
  ...
  Route::group([
   'middleware' => 'isLogin'
     ...
     Route::get('members/products/purchased/{id}', 'ProductController@purchasedView');
      Route::get('members/payments/{Item}', 'MemberController@getEnlacePayment');
  });


Route::get('/r/{referralCode}', 'MemberController@link')->name('referral.link');
