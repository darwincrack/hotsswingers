...
<div class="dashboard-long-item">
  <div class="dashboard_tabs_wrapper">
      ...
      <a class="btn btn-dark pull-left <?= (!isset($action) || ($action === '')) ? 'active' : '' ?>" href="{{URL('members/account-settings')}}">@lang('messages.accountInformation')</a>
      <a class="btn btn-dark pull-left {{Request::is('*/account-settings/other-settings') ? 'active' : ''}}" href="{{URL('members/account-settings/other-settings')}}">@lang('messages.timezone')</a>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="form-group required">
                <label for="passw1" class="col-sm-4 col-md-3 control-label">@lang('messages.oldPassword') </label>
                <div class="col-sm-9">
              ...
              <div class="form-group required">
                <label for="newPassword_confirmation" class="col-sm-4 col-md-3 control-label">@lang('messages.retypePassword') </label>
                <div class="col-sm-9">
              ...
              <div class="form-group text-center bottom-button-wrap">
                <div class="col-sm-12">
                  <button type="submit" class="btn btn-danger btn-lg">@lang('messages.saveChange')</button>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="user-setting-item">
    <div class="change_psw">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="form-group required">
                <label class="col-sm-3 control-label " for="username">@lang('messages.username') </label>
                <div class="col-sm-9">
              ...
              <div class="form-group required">
                <label for="sex" class="col-sm-3 control-label ">ssdd @lang('messages.sex') </label>
                <div class="col-sm-9">
              ...
              <div class="form-group required">
                <label class="col-sm-4 col-md-3 control-label">@lang('messages.firstname')</label>
                <div class="col-sm-9">
              ...
              <div class="form-group required">
                <label class="col-sm-4 col-md-3 control-label">@lang('messages.lastName') </label>
                <div class="col-sm-9">
              ...
              <div class="form-group required <?= $errors->has('email') ? 'has-error' : '' ?>">
                <label for="email" class="col-sm-4 col-md-3 control-label">@lang('messages.email') </label>
                <div class="col-sm-9">
              ...
              <div class="form-group required">
                <label class="col-sm-3 control-label" for="location">@lang('messages.country') </label>
                <div class="col-sm-9">
              ...
              <div class="form-group">
                <label class="col-sm-4 col-md-3 control-label">@lang('messages.mobilePhone')</label>
                <div class="col-sm-9">
