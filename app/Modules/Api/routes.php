...
Route::post('member/send-tip-tokens-privados/{roomId}', 'PaymentTokensController@sendTipTokensPrivados');

  Route::get('participantes/{id}', 'UserController@Participantes');
Route::get('find-participantes/{id}', 'UserController@FindParticipantes');
  ...
  //Juegos
   ...
   Route::get('games/{id}', 'GamesController@getGames');
   Route::get('juguetes/{id}', 'GamesController@getJuguetes');
  Route::get('allgames/{id}', 'GamesController@getAllGames');
  Route::get('lastgames/{id}', 'GamesController@getLastGames');


//multiretos
Route::get('multiretos/user/{id}', 'MultiretosController@get');
Route::get('multiretos/user/first/{id}', 'MultiretosController@getFirst');
Route::get('multiretos/user/next/{id}', 'MultiretosController@getNext');
Route::post('multiretos/ganancias/{id}', 'MultiretosController@Ganancias');



  //premios
   Route::get('user/setconnect/{modelId}/{userConnect}', 'PremiosGanadoresController@SetConnect');
...
//travel 
  ...
  Route::get('travel', 'UserController@getTravel');

  Route::post('traveladd', 'UserController@SetTravel');

  Route::post('traveldelete', 'UserController@deleteTravel');
  //get models
