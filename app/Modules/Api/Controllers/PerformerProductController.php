  ...
  public function buy(Request $req, $id) {
    ...
    if (!$product) {
      return Response()->json([
        'success' => false,
        'data' => [
          'message' => trans('messages.productnotfound')
        ]
      ]);
    }
    ...
    if ($quantity > $product->inStock) {
      return Response()->json([
        'success' => false,
        'data' => [
          'message' => trans('messages.Stockisnotenough')
        ]
      ]);
    }
    ...
    if ($user->tokens < $token) {
      return Response()->json([
        'success' => false,
        'data' => [
          'message' => trans('messages.Tokenisnotenough')
        ]
      ]);
    }
    ...
    if (!$tracking->save()) {
      return Response()->json([
        'success' => false,
        'data' => [
          'message' => trans('messages.Cannotcreatepayment')
        ]
      ]);
    }
    ...
    return Response()->json([
      'success' => true,
      'data' => [
        'message' => trans('messages.Purchasesuccessfully')
      ]
    ]);
  }
}