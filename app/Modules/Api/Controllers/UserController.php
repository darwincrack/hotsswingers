...
/*if($req->get('filter')== 'misviajes'){
 ...
 public function checkmydate($date) {
  ...
  public function Participantes($uid = null) {

    return VideoprivadotokensModel::participantes($uid);
  }



  public function FindParticipantes($uid = null) {
    $userData = AppSession::getLoginData();
    if($userData){

      return VideoprivadotokensModel::get($uid,  $userData->id);
    }

    return Response()->json(['tokensprivado' => 0]);
