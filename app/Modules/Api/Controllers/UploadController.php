...
//        event(new ActionGenerate($attachment));
        ...
        return Response()->json(array('success' => true, 'errors' => '', 'message' => trans('messages.uploadSuccessfully'), 'file' => $attachment));
//return Redirect::to('upload');
      } else {
// sending back with error message.
        return Response()->json(array('success' => false, 'error' => trans('messages.uploadFileNotValid'), 'message' => ''));
      }
    }
  }
...
//like or dislike
  public function likeMe(Request $req) {
    ...
    if (\Session::has('UserLogin')) {
      ...
      return response()->json(['status' => 'error', 'message' => trans('messages.pleaseyouhavetologinbefore')]);
    }
  }
...
//TODO Delete comment, like
      return Response()->json(array('success' => true, 'error' => '', 'message' => trans('messages.SuccessThewassuccessfullydeleted')));
    }
    return Response()->json(array('success' => false, 'error' => trans('messages.Filenotexist'), 'message' => ''));
  }
