...
Route::group(array('module' => 'Model', 'namespace' => 'App\Modules\Model\Controllers'), function() {
  ...
  Route::group(array('middleware' => 'isModel'), function() {
    ...
    Route::get('models/dashboard/geo-blocking/code/{countryCode}', 'GeoController@countryCode');
    Route::get('models/dashboard/geo-blocking/code/remove/{countryCode}', 'GeoController@remove');
    Route::post('models/dashboard/geo-blocking/store', 'GeoController@Store');
    ...
    Route::post('models/dashboard/account-settings/contrato', 'ModelController@updateContratoSetting');
    ...
    Route::get('models/dashboard/travel', 'ModelController@getTravel');
