...
class ProductController extends Controller {
  ...
  public function update(Request $req, $id) {
    ...
    $noproductavailable = trans('messages.noproductavailable');
    ...
    if (!$product) {
      throw new Exception($noproductavailable);
    }
  ...
  public function view($id) {
    ...
    $productnotfound = trans('messages.productnotfound');
    ...
    if (!$product) {
      throw new Exception($productnotfound, 404);
    }
  ...
  public function deleteProduct(Request $req, $id) {
    ...
    $deleteitemsuccessfull = trans('messages.deleteitemsuccessfull');
    $nopermissiontodothat = trans('messages.nopermissiontodothat');
    ...
    if ($product && $product->performerId != $performer->id) {
      throw new Exception($nopermissiontodothat, 403);
    }
    
    $product->delete();
    DB::table('performer_product_tracking')->where('productId', '=', $id)->delete();
    return back()->with('msgInfo', $deleteitemsuccessfull);
  }
}
