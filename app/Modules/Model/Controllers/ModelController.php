    ...
    //specify your custom message here
        $messages = [
          'required' => 'El campo es requerido'
            ...
            $validator = Validator::make(Input::all(), [
          'idImage' => 'Mimes:jpg,jpeg,png|Required',
          'idImage2' => 'Mimes:jpg,jpeg,png|Required',
          'faceId' => 'Mimes:jpg,jpeg,png|Required',
          'usernameContrato' => 'Required|String',
          'fechaNacimientoContrato' => 'Required',
          'fechaFirmaContrato' => 'Required',
          'idImage.Required' => 'DNI adverso es requerido'
      ],  $messages);
