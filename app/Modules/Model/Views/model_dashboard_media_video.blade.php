...
<div class="col-sm-12 col-md-12">
  <div class="panel panel-default">
    <div class="panel-heading"> <h4>@lang('messages.videos')</h4></div>
    <div class="panel-body" ng-controller="modelVideoGalleryCtrl" ng-init="galleryInit()" ng-cloak>
      <a href="{{URL('models/dashboard/media/video-gallery/upload')}}" class="btn btn-danger m20"><i class="fa fa-plus-circle"></i>@lang('messages.uploadVideos')</a>
      <ul class="row list-picvideo">
        <li class="col-sm-4 col-md-4" ng-repeat="(key, video) in myVideos" >
          <div class="box-picvideo">
            ...
            <div class="line-picvideo">
              <div class="action-picvideo"><% video.title %></div><br>
              <div class="action-picvideo"><% video.status %></div><br>
               <div class="action-picvideo"> <strong><% video.estado | estadoGalerias:'es' %></strong></div>
