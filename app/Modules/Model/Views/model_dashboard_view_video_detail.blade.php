...
*/ ?>
  <div class="panel panel-default">
    <div class="panel-heading"> <h4>@lang('messages.videoDetail'): {{$video->title}}<a class="pull-right" href="{{URL('models/dashboard/media/edit-video/'.$video->id)}}">@lang('messages.editVideo')</a></h4></div>
          ...
          <div class="row">
            ...
            <div class="col-sm-8 col-md-8">
              <div class="main_inf">
                ...
                <div class="mod_age"><span>@lang('messages.price'):</span><span></span>{{$video->price}} Tokens</div>

                <div class="mod_loc"><span>@lang('messages.length'):</span> <span>{{AppHelper::videoDuration($video->fullMeta)}}</span></div>
                <div class="mod_for"><span>@lang('messages.dimensions'):</span> <span>{{AppHelper::videoDimension($video->fullMeta)}}</span></div>
                <div class="mod_for"><span>@lang('messages.description'):</span> <span>{{$video->description}}</span></div>
              </div>
            </div>
          </div>
          ...
          <div class="row">    
            <div class="col-md-12 ">
              <div class="card">
                ...
                <div class="card-content">
                  <span class="card-title">@lang('messages.videotrailer')</span>                    
            ...
            <div class="col-md-12 ">
              <div class="card">
                ...
                <div class="card-content">
                  <span class="card-title">@lang('messages.fullVideoReview')</span>                    
                </div><!-- card content -->              
              </div>
            </div>
          </div>
