...
<div class="right_cont"> <!--all left-->
  ...
  <?php if ($action && $action == 'contrato') {   ?>
 
           <div class="panel panel-default">
        <div class="panel-heading"> <h4>Acuerdo independiente de emisor/a</h4> 

           @if($document)


         @if($document->contrato == 1 )
          <span class="label label-warning">En espera de aprobacion por el admin</span>
         @elseif($document->contrato == 2 )
        ...
        <div class="panel-body">
          <form class="form-horizontal" action="/models/dashboard/account-settings/contrato" method="post" >
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-9">
                <input type="text" name="usernameContrato" id="usernameContrato"  class="form-control input-md">
                  ...
                  <span class="label label-danger">{{$errors->first('usernameContrato')}}</span>
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-9">
                <input type="date" name="fechaNacimientoContrato" id="fechaNacimientoContrato"  class="form-control input-md" >
                 ...
                 <span class="label label-danger">{{$errors->first('fechaNacimientoContrato')}}</span>
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-9">
                <input type="date" name="fechaFirmaContrato" id="fechaFirmaContrato"  class="form-control input-md" >
                     <span class="label label-danger">{{$errors->first('fechaFirmaContrato')}}</span>
              </div>
            </div>
...
<br>
            ...
            <fieldset class="form-group">
              <label class="col-sm-3 control-label" for="fechaFirmaContrato">Fecha de firma:sfdf </label>
              <div class="col-sm-9">
...
Mediante la firma electrónica de este documento el Creador Independiente se compromete al cumplimiento de las estipulaciones de este Acuerdo en la fecha de firma del mismo. El Creador Independiente puede solicitar una copia de este Acuerdo en la dirección de correo electrónico <a href="mailto:info@implik-2.com">info@implik-2.com</a>.
            ...
            @else 
                ...
                @if(( $document->contrato == 0 or $document->contrato == 1))
