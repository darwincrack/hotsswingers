            ...
            <div class="col-md-6">
              ...
              <ul ng-if="videoRequests.length">
                <li ng-repeat="request in videoRequests">
                  <span><a ng-href="<% request . requestUrl %>">@lang('messages.amember') (<%request.name%>) @lang('messages.sendsaprivatecallrequestclickheretofindoutwho')</a></span>
                </li>
              </ul>
            </div>
            <div class="col-md-6">
