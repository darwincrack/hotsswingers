...
$fechaInicial = $model->birthdate;
$subirthdate = $model->subirthdate;
  ...
  <div class="right_cont panel-body"> <!--all left-->
        ...
        <div class="dashboard-long-item">
          <div class="dashboard_tabs_wrapper">
            <div class="dashboard_tabs">
              ...
              <a class="btn btn-info active" href="{{URL('models/dashboard/profile')}}">@lang('messages.myProfile')</a>
              <a class="btn btn-default" href="{{URL('models/dashboard/profile/edit')}}">@lang('messages.editMyProfile')</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="studio-cont"> <!--user's info-->
      <div class="table-responsive cont_det">
        <h3>@lang('messages.yourPersonalInfo')
        </h3>

        <table class="table table-bordered">
          <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.firstname')</strong></td>
            <td>{{!empty($model->firstName) ? $model->firstName : $myUnknown}}</td>
          </tr>
          <tr>
            <td class="text-right"><strong>@lang('messages.lastname')</strong></td>
            <td>{{!empty($model->lastName) ? $model->lastName : $myUnknown}}</td>
          </tr>
          <tr>
            <td class="text-right"><strong>@lang('messages.sex')</strong></td>
            <td>{{!empty($model->gender) ? $sex[$model->gender][$idioma] : $myUnknown}}</td>
          </tr> 
        ...
        @if ($model->gender == 'pareja')


        <table  class="table table-bordered" style="border: 0px solid;">
          <tr style="border: 0px solid;">
            <td class="text-right" style="text-align: center;border: 0px solid;width: 50%;">@lang('messages.traduc7') (@lang('messages.he'))</td>
            <td class="text-right" style="text-align: center;border: 0px solid;width: 50%;">@lang('messages.traduc26')</td>
          </tr>  
        </table>

        <table  class="table table-bordered">
          <tr>
            <td class="text-right" style="width: 25%"><strong> @lang('messages.age') </strong></td>
            <td style="width: 25%">
@if(!empty($model->agellla))
{{$model->agellla}}
@else
{{ $yearsel }}
@endif
...
@endif
          ...
          <tr>
            <td class="text-right" style="width: 25%"><strong> @lang('messages.height')</strong></td>
            <td style="width: 25%">{{!empty($model->ellacm) ? $model->ellacm : $myUnknown}}</td>
            <td class="text-right" style="width: 25%"><strong> @lang('messages.height') </strong></td>
            <td style="width: 25%">{{!empty($model->elcm) ? $model->elcm : $myUnknown}}</td>
          </tr>
          <tr>
            <td class="text-right" style="width: 25%"><strong> @lang('messages.traduc15')</strong></td>

            <td style="width: 25%">{{!empty($model->ellaetnia) ? $model->ellaetnia : $myUnknown}}</td>
            
            <td class="text-right" style="width: 25%"><strong> @lang('messages.traduc15') </strong></td>

            <td style="width: 25%">{{!empty($model->eletnia) ? $model->eletnia : $myUnknown}}</td>
          </tr>
          <tr>
            <td class="text-right" style="width: 25%"><strong> @lang('messages.traduc13')</strong></td>
            <td style="width: 25%">{{!empty($model->ellafionomia) ? $model->ellafionomia : $myUnknown}}</td>


            <td class="text-right" style="width: 25%"><strong> @lang('messages.traduc13') </strong></td>

            <td style="width: 25%">{{!empty($model->elfisionomia) ? $model->elfisionomia : $myUnknown}}</td>
          ...
          <tr>
            <td class="text-right" style="width: 25%"><strong>@lang('messages.weight')</strong></td>
            <td style="width: 25%">{{!empty($model->weight) ? $model->weight : $myUnknown}}</td>            
       


           
            <td class="text-right" style="width: 25%"><strong>@lang('messages.weight')</strong></td>
            <td style="width: 25%">{{!empty($model->weight_ella) ? $model->weight_ella : $myUnknown}}</td>            
          </tr>


          <tr>
            <td class="text-right" style="width: 25%"><strong>@lang('messages.hair')</strong></td>
            <td style="width: 25%">{{!empty($cabello[$model->hair]) ? $cabello[$model->hair] : $myUnknown}}
            </td>            
            ...
            <td class="text-right" style="width: 25%"><strong>@lang('messages.hair')</strong></td>
            <td style="width: 25%">{{!empty($cabello[$model->hair_ella]) ? $cabello[$model->hair_ella] : $myUnknown}}
            </td>            
          </tr>
          ...
          <tr>
            <td class="text-right" style="width: 25%"><strong>@lang('messages.eyes')</strong></td>
            <td style="width: 25%">{{!empty($eyess[$model->eyes]) ? $eyess[$model->eyes] : $myUnknown}}
            </td>            
            ...
            <td class="text-right" style="width: 25%"><strong>@lang('messages.eyes')</strong></td>
            <td style="width: 25%">{{!empty($eyess[$model->eyes_ella]) ? $eyess[$model->eyes_ella] : $myUnknown}}
            </td>            
          </tr>
          ...
          <tr>
            <td class="text-right" style="width: 25%"><strong>@lang('messages.pubicHair')</strong></td>
            <td style="width: 25%">{{!empty($pubico[$model->pubic]) ? AppHelper::addWhitespaceText($pubico[$model->pubic], '_') : $myUnknown}}
            </td>            
            ...
            <td class="text-right" style="width: 25%"><strong>@lang('messages.pubicHair')</strong></td>
            <td style="width: 25%">{{!empty($pubico[$model->pubit_ella]) ? AppHelper::addWhitespaceText($pubico[$model->pubit_ella], '_') : $myUnknown}}
            </td>            
          </tr>


          <tr>
            <td class="text-right" style="width: 25%"><strong></strong></td>
            <td style="width: 25%">
            </td>            
            ...
            <td class="text-right" style="width: 25%"><strong>@lang('messages.bust')</strong></td>
            <td style="width: 25%">{{!empty($busto[$model->bust]) ? AppHelper::addWhitespaceText($busto[$model->bust], '_') : $myUnknown}}
            </td>            
          </tr>
        ...
        <table class="table table-bordered">
          <tr>
            <td class="text-right" style="width: 50%"><strong> @lang('messages.age') </strong></td>
            <td style="width: 50%">
...
@endif
          ...
          <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.height')</strong></td>
            <td style="width: 50%">{{!empty($model->ellacm) ? $model->ellacm : $myUnknown}}</td>
          </tr>

          <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.ethnicity')</strong></td>
            <td style="width: 50%">{{!empty($model->ellaetnia) ? $model->ellaetnia : $myUnknown}}</td>
          </tr>          
          <tr>
            <td class="text-right" style="width: 25%"><strong> @lang('messages.traduc13')</strong></td>
            <td style="width: 25%">{{!empty($model->ellafionomia) ? $model->ellafionomia : $myUnknown}}</td>
                    ...
                    <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.weight')</strong></td>
            <td style="width: 50%">{{!empty($model->weight) ? $model->weight : $myUnknown}}</td>            
          </tr>

          <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.hair')</strong></td>
              <td style="width: 50%">{{!empty($cabello[$model->hair]) ? $cabello[$model->hair] : $myUnknown}}</td>           
          </tr>

          <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.eyes')</strong></td>
            <td style="width: 50%">{{!empty($eyess[$model->eyes]) ? $eyess[$model->eyes] : $myUnknown}}</td>  
            </tr>

          <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.pubicHair')</strong></td>
                 <td style="width: 50%">{{!empty($pubico[$model->pubic]) ? AppHelper::addWhitespaceText($pubico[$model->pubic], '_') : $myUnknown}}</td>            
            
          </tr>
          <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.bust')</strong></td>
            <td style="width: 50%">{{!empty($busto[$model->bust]) ? AppHelper::addWhitespaceText($busto[$model->bust], '_') : $myUnknown}}</td>            
          </tr>
        ...
        <table class="table table-bordered">
          ...
          <tr>
            <td class="text-right"><strong>@lang('messages.sexualPreference')</strong></td>
            <td>

                @foreach($elpreferencia as $aKey => $aSport2)
            ...
            <tr>
              ...
              <td class="text-right">
                <strong>@lang('messages.likes')</strong>
              </td>

              <td>

                  @foreach($elgusta as $aKey => $aSport)
         ...
         <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.experiencia')</strong></td>
            <td style="width: 50%">{{  $experiencia[$model->experiencias]}}</td>
          </tr>



          <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.languages')</strong></td>
            <td style="width: 50%">{{!empty($model->languages) ? $model->languages : $myUnknown}}</td>            
          

          </tr>

          <tr>
            <td class="text-right" style="width: 50%"><strong>@lang('messages.category')</strong></td>
            <td style="width: 50%">{{$model->multiCategoryName()}}</td>
          </tr>
        ...
        <h3>@lang('messages.publicLocationInfo')</h3>
        <table class="table table-bordered">
          <tr>
            <td style="width: 50%">@lang('messages.country')</td>
            <td>{{!empty($model->countryName) ? $model->countryName : $myUnknown }}</td>
          </tr>
          <tr>
            <td>@lang('messages.state')</td>
            <td>{{!empty($model->state_name) ? $model->state_name : $myUnknown}}</td>
          </tr>
          <tr>
            <td>@lang('messages.city')</td>
            <td>{{!empty($model->city_name) ? $model->city_name : $myUnknown}}</td>
          </tr>
        </table>
...
<h3>Acuerdo independiente de emisor/a</h3>
...
Mediante la firma electrónica de este documento el Creador Independiente se compromete al cumplimiento de las estipulaciones de este Acuerdo en la fecha de firma del mismo. El Creador Independiente puede solicitar una copia de este Acuerdo en la dirección de correo electrónico <a href="mailto:info@implik-2.com">info@implik-2.com</a>.
    ...
    <table class="table table-bordered">
          <tr>
            ...
            <td style="width: 50%">Firmo el contrato?</td>
            <td>              
              @if(!empty($document->usernameContrato ) and !empty($document->fechaNacimientoContrato ) and !empty($document->fechaFirmaContrato ))
                SI
              @else 
                NO
              @endif</td>
          ...
          <tr>
            ...
            <td> {{!empty($document->usernameContrato) ? $document->usernameContrato : '' }}</td>
          </tr>
          <tr>
            <td>Fecha de nacimiento</td>
            <td>   {{!empty($document->fechaNacimientoContrato) ? date('d-m-Y', strtotime($document->fechaNacimientoContrato)): '' }}</td>
          </tr>
          <tr>
            ...
            <td>{{!empty($document->fechaFirmaContrato) ? date('d-m-Y', strtotime($document->fechaFirmaContrato)): '' }}</td>
          </tr>
        </table>
          ...
          <h3>@lang('messages.whatAboutYou')</h3>
