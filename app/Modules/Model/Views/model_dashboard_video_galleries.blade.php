...
@section('content_sub_model')
  <div class="panel panel-default">
    ...
    <div class="panel-body" ng-controller="modelVideoGalleriesCtrl" ng-init="listGalaryInit()" ng-cloak>
      <a href="{{URL('models/dashboard/media/add-video-gallery')}}" class="btn btn-danger m20"><i class="fa fa-plus-circle"></i> @lang('messages.addanewvideogallery')</a>
        ...
        <li class="col-sm-4 col-md-3" ng-repeat="(key, gallery) in myGalleries" ng-cloak>
          <div class="box-model">
            ...
            <div class="text-box-model caption">
              ...
              <a class="btn btn-warning input-block-level form-control" href="{{URL('models/dashboard/media/video-gallery/upload?id=')}}<% gallery . id %>"><i class="fa fa-upload"></i> @lang('messages.uploadVideos')</a>
            </div>
