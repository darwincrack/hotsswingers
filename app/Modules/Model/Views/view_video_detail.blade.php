  ...
  <div class="item profile-gallery clearfix">
    <div class="pull-left pull-left-style">
      <div class="profile-gallery-stats">
        <span><strong>0</strong> @lang('messages.newItems')</span>
        <span><strong>0</strong> @lang('messages.videos')</span>
      </div>
    </div>
    <div class="pull-right pull-right-style">
      ...
      <div id="video-like" class="gallery-item" style="margin:0">
        <div class="actions-video clearfix">
          <div class="pull-left">
            <strong class="count_like">0</strong> @lang('messages.likes')
          </div>
        ...
        <div class="details">
          <div class="row-fluid">
            <div class="span8">
              <div class="title">@lang('messages.castinglesbianmodelstwosexygirls')</div>
              <p>@lang('messages.castinglesbianmodelstwosexygirls')</p>
            </div>
            <div class="span4">
              <table class="table" border="0" width="100%">
                <tbody>
                  <tr>
                    <td align="right">@lang('messages.fromGallery')</td>
                    <td align="left"><strong><?= $galleryInfo->name ?></strong>
                    </td>
                  </tr>
                  <tr>
                    <td align="right">@lang('messages.postedBy')</td>
                    <td align="left"><strong><a href="{{URL('profile')}}/<?= $model->username ?>"><?= $model->username ?></a></strong>
                    </td>
                  </tr>
                  <tr>
                    <td align="right">@lang('messages.addedOn')</td>
      ...
      <div style="margin-top:20px;" class="row gallery">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4 span3">
          ...
          <div class="details">
            <a href="#" class="title">@lang('messages.castingLesbianModels')</a>
            <div class="uploader">
              <a href="#" class="avatar">
                <img src="<?= AppHelper::modelCheckThumb($model->avatar) ?>">
              </a>
              <span>@lang('messages.uploadedby'):
                <a href="<?= URL('profile/' . $model->username . '') ?>"><?= $model->username ?></a>
              </span>
