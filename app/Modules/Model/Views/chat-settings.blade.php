...
<div class="right_cont"> <!--all left-->
  <div class="panel-heading"><h4>@lang('messages.chatSettings')</h4></div>
    ...
    <div class="mod_chat_settings_cont"  ng-controller="chatSettingCtrl" ng-cloak>
      <form class="form-horizontal"  novalidate name="frmChatSettings" ng-submit="saveChanges(frmChatSettings)" method="post">
        <div class="panel panel-default">
          ...
          <h4>@lang('messages.pricingSettings')</h4>
          </div>
          <div class="panel-body">
            <div class="form-group">
              <label for="performerchat[private_price]" class="col-sm-4 control-label input-lg">@lang('messages.privatechatpricemin')</label>
              <div class="col-sm-8">
                <select class="form-control input-lg" name="performerchat[private_price]" id="performerchat_private_price" ng-model="performerchat.private_price" convert-to-number ng-show="performerchat.isCustomPrivate != 1">
                  <option value="0">@lang('messages.pleaseSelectAnOption')</option>
                ...
                <input type="checkbox" name="isCustomPrivate" ng-model="performerchat.isCustomPrivate" class="input-custom-price" value="1"/> @lang('messages.customprice')

              </div>
            </div>
            <div class="form-group">
              <label for="performerchat[group_price]" class="col-sm-4 control-label input-lg">@lang('messages.groupchatpricemin')</label>
              <div class="col-sm-8">
                ...
                <input type="checkbox" name="isCustomGroup" ng-model="performerchat.isCustomGroup" class="input-custom-price" value="1"/> @lang('messages.customprice')
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-4 input-lg" for="welcome_message">@lang('messages.welcomeMessage')</label>
              <div class="col-sm-8">
                <input class="form-control input-lg" name="welcome_message" ng-model="performerchat.welcome_message" ng-maxlength='140'>
                <span ng-show="frmChatSettings.welcome_message.$error.maxlength" class="label label-danger">@lang('messages.welcomeMessageMaxLength140')</span>
              </div>
            </div>
          </div>
        </div>
        <div class="form-group text-center">
            <button type="submit" class="btn btn-danger btn-lg">@lang('messages.saveChanges')</button>
        </div>
      </form>
    </div>
