...
<div class="right_cont"> <!--all left-->
  <div class="user-header row"> <!--user header-->
    <div class="col-sm-12">
      <div class="l_i_name ">@lang('messages.addNewImage')</div>
    </div>
  </div><!--user header end-->
  <div class="mod_settings_cont" ng-controller="modelCreateGalleryCtrl" ng-cloak> <!--user's info-->
    <form role='form' method="post" name="newGalleryForm" class="form-horizontal" ng-submit="newGalleryForm.$valid && submitCreateImage(newGalleryForm)" novalidate>
      ...
      <div class="form-group required">
        <label class="control-label col-sm-3 text-right" for="galleryDesc">@lang('messages.image') </label>
        <div class="col-sm-9">
        ...
        <label class="col-sm-3 control-label text-right" for="galleryPrice">@lang('messages.price')</label>
        <div class="col-sm-9">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
          ...
          <label class="radio-inline">
            <input type="radio" name="galleryStatus" id="galleryStatusPrivate" ng-model="gallery.status" value="private" checked> @lang('messages.private')
          </label>
        <label class="radio-inline">
      ...
      <div class="row">
        ...
        <div class="col-sm-9 text-left"><button type="submit" id="submit" name="submit" class="btn btn-primary"  ng-disabled="newGalleryForm.$submitted && submitted">@lang('messages.addImage')</button></div>
      </div>
