...
<div class="col-sm-12 col-md-12">
  <div class="panel panel-default">
    <div class="panel-heading"> <h4>Video Gallery: {{stripcslashes($gallery -> name)}}</h4></div>
    <div class="panel-body" ng-controller="modelVideoGalleryCtrl" ng-init="galleryInit({{$gallery -> id}})" ng-cloak>
      <a href="{{URL('models/dashboard/media/video-gallery/upload?id='.$gallery -> id)}}" class="btn btn-danger m20"><i class="fa fa-plus-circle"></i> @lang('messages.uploadVideos')</a>
