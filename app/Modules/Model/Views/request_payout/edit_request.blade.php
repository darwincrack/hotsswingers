...
<div ng-controller="modelPayoutRequestCtrl" ng-init="init('performer', '{{$request->dateFrom}}', '{{$request->dateTo}}')">
    ...
    <div class="panel panel-default">
      ...
      <div class="right_cont panel-body">
        <div class="row">
          ...
          <div class="col col-md-6 earning-for-requested-date-box" ng-if="earningByRequestedDate">
            <br>
