...
@section('title', 'Propinas y pago privado / grupal')
@section('breadcrumb', '<li><a href="/admin/dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li><li class="active">Propina y Privado / Grupo</li>')
@section('content')
