...
@section('title', 'Pago de galerías (Galleries Payment)')
@section('breadcrumb', '<li><a href="/admin/dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li><li class="active">Galerías</li>')
@section('content')
