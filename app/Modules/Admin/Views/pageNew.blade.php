...
<div class="row">
  ...
  <fieldset class="form-group">
            <?php echo Form::label('lenguage', 'lenguage', array('class' => 'control-label col-sm-3'));?>
            <div class="col-sm-4">
            <?php echo Form::select('idioma', array('es' => 'es', 'en' => 'en','fr'=>'fr'), old('idioma', 'es'), array('class'=>'form-control input-lg'));?>
          ...
          <fieldset class="form-group">
            ...
            <div class="col-sm-4">
            <?php echo Form::select('status', array('active' =>  trans('messages.active'), 'inactive' => trans('messages.Inactive')), old('status', 'active'), array('class'=>'form-control input-lg'));?>
