...
@section('title', 'Galeria de VIDEOS- '.stripcslashes($gallery -> name))
@section('breadcrumb', '<li><a href="/admin/manager/video-gallery/'.$gallery->ownerId.'"><i class="fa fa-dashboard"></i> Galerías</a></li><li class="active">Galerías de video</li>')
@section('content')
  ...
  <section class="content col-md-12">
    <div class="box">
        ...
        <div class="box-header">
          <h3 class="box-title"><a href="{{URL('admin/manager/media/video-gallery/'.$gallery->ownerId.'/upload/'.$gallery->id)}}" class="btn btn-info m20"><i class="fa fa-plus-circle"></i> Agregar Video</a></h3>
        </div>
