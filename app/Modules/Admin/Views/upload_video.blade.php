...
@section('breadcrumb', '<li><a href="/admin/manager/video-gallery/'.$modelId.'"><i class="fa fa-dashboard"></i> Videos</a></li><li class="active">Subir video</li>')
@section('content')
<div class="row">
  <!-- left column -->
  <div class="col-md-8">
          ...
          <div class="box-body">
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-9">
                ...
                <span ng-show="newVideoForm.videoTitle.$error.minlength" class="label label-danger">Ingrese al menos 5 caracteres.</span>
            ...
            <div class="form-group required">
              ...
              <div class="col-sm-9">
                ...
                <span ng-show="newVideoForm.videoDesc.$error.minlength" class="label label-danger">Ingrese al menos 5 caracteres.</span>
