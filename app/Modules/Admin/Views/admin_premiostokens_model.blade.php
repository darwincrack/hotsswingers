...
@section('title', 'Asignar premios por cantidad de tokens obtenidos en las cams')
@section('breadcrumb', '<li><a href="/admin/dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li><li class="active">Asignar premios por cantidad de tokens obtenidos en las cams</li>')
@section('content')
<div class="row">
  <div class="col-sm-12">
