...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Se te olvidó tu contraseña | {{app('settings')->siteName}}</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <h1>Administrador restablecer contraseña</h1>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Reinicia tu cuenta</p>
        {{Form::open(array('method'=>'post'))}}
          <div class="form-group has-feedback">
            ...
            <div class="form-group">
              <button type="submit" class="btn btn-primary btn-block btn-flat">Restablecer la contraseña</button>
            </div><!-- /.col -->
          
        {{Form::close()}}

        <a href="{{URL('admin/login')}}">Iniciar sesión</a><br>
      </div><!-- /.login-box-body -->
    </div><!-- /.login-box -->
    <!-- REQUIRED JS SCRIPTS -->
