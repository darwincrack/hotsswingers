<?php
  ...
  class ChatMessageController extends Controller {
          ...
          $grid = new Grid(
                  (new GridConfig)
                          ...
                          ->setColumns([
                              ...
                              ->setLabel('Acciones')
                              ->setCallback(function ($val) {
                                  return "<a href='" . URL('admin/manager/message/delete/' . $val) . "' onclick=\"return confirm('¿Seguro que quieres borrar este mensaje?')\"><span class='fa fa-ban'></span></a>";
                              })
                              ->setSortable(false)
                                  ,
                          ])
      ...
      public function destroy($id) {
          ...
          if (!$chat) {
              return Back()->with('msgError', 'No se encuentra el mensaje de chat.');
          }
          if ($chat->delete()) {
              return back()->with('msgInfo', 'El mensaje de chat se eliminó correctamente.');
          }
          return back()->with('msgError', 'Eliminar error de mensaje de chat.');
      }
