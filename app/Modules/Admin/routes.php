...
//  Route::resource('admin', 'AdminController');
  ...
  Route::group(array('middleware' => 'AdminCheckLogin', 'prefix' => 'admin'), function() {
    ...
    Route::get('manager/conversaciones', 'UserController@getConversaciones');
    ...
    //aprobar imagenes y videos
    Route::get('manager/aprobar/gallery/list', 'GalleryController@getGalleryList');
    Route::get('manager/aprobar/gallery/{id}', 'GalleryController@aprobarGaleria');
    Route::get('manager/rechazar/gallery/{id}', 'GalleryController@rechazarGaleria');




    Route::get('manager/aprobar/video/list', 'GalleryController@getVideoList');
    Route::get('manager/aprobar/video/{id}', 'GalleryController@aprobarVideo');
    Route::get('manager/rechazar/video/{id}', 'GalleryController@rechazarVideo');
    ...
    //premios
 	Route::get('manager/premios/model', 'PremiosController@getModelsPremios');
    Route::get('manager/premios/tokens', 'PremiosController@getPremiosTokens');
    Route::post('manager/premios/tokens', 'PremiosController@SetPremiosTokens');
    Route::get('manager/premios/ganadorestokens', 'PremiosController@ListGanadoresPremiosTokens');



   Route::get('manager/premios/likes', 'PremiosController@getPremiosLikes');


    //Route::get('manager/premios/setrefe', 'PremiosController@setReferidos');
