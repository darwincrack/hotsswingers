  ...
  class LoginController extends Controller {
      ...
      public function postLogin() {
        \App::setLocale(session('lang'));
          ...
          if (!$user) {
              ...
              return Redirect('studio/login')->withInput()->with('msgError', \lang::get('messages.Usernamepassworddoesnotmatch'));
          }
  
          if ($user->emailVerified == 0) {
              return redirect('login')->with('msgError', \lang::get('messages.notVerifyEmailMemberLogin'));
      ...
      public function actionStudioLogout() {
        \App::setLocale(session('lang'));
          ...
          return redirect('studio')->with('msgInfo', \Lang::get('messages.Goodbye'));
      }
