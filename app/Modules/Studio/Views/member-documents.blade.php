    ...
    <div class="mod_shedule"> <!--user's info-->
      {!! Form::open(array('method' => 'POST', 'role' => 'form', 'enctype' => 'multipart/form-data')) !!}
        <fieldset class="form-group">
          <label class="label-control col-md-3 col-sm-10">@lang('messages.idimage')</label>
         ...
         <fieldset class="form-group">
          <label class="label-control col-md-3 col-sm-10">@lang('messages.idimage2')</label>
          <div class="col-md-9 col-sm-10">
            <input name="idImage2" id="idImage2" type="file" />
            <label class="text-red">{{$errors->first('idImage2')}}</label>
            @if($document && $document->idImage2)
            <img class="img-responsive" src="{{URL($document->idImage2)}}">
            @endif
          </div>
        </fieldset>
        <fieldset class="form-group">
          <label class="label-control col-md-3 col-sm-10">@lang('messages.faceid')</label>
          <div class="col-md-9 col-sm-10">
        ...
        <fieldset class="form-group">
          <label class="label-control col-md-3 col-sm-10">@lang('messages.releaseForm')</label>
          <div class="col-md-9 col-sm-10">
