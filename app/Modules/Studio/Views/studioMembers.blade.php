...
<div class="right_cont"> <!--all left-->
  ...
  <a class=" {{\Request::is('studio/members')? 'active':''}}" href="{{URL('studio/members')}}">@lang('messages.allMembers')</a>
  <a class=" {{\Request::is('studio/members/add')? 'active':''}}" href="{{URL('studio/members/add')}}">@lang('messages.addNewMember')</a>
  </div>
</div><!--user header end-->
        ...
        <form class="form-inline" action="{{URL('studio/members')}}" role="form">
          ...
          <div class="form-group">
            ...
            <select id="pref-perpage" name="modelOnlineStatus" style="max-width:100% " class="form-control">
              <option value="all" <?php echo (Request::get('modelOnlineStatus') == 'all') ? 'selected="selected"':''?>>@lang('messages.all')</option>
              <option value="active" <?php echo (Request::get('modelOnlineStatus') == 'active') ? 'selected="selected"':''?>>@lang('messages.Active')</option>
              <option value="suspend" <?php echo (Request::get('modelOnlineStatus') == 'suspend') ? 'selected="selected"':''?>>@lang('messages.suspended')</option>
            </select>
          </div> <!-- form group [rows] -->
          <div class="form-group">
    ...
    <div class="mod_shedule"> <!--user's info-->
      <form class="form-horizontal" method="POST" action="{{URL('studio/members/add')}}">
        <div class="form-group {{($errors->has('firstName'))? 'has-error' : '' }}">
          <label class="col-sm-3 control-label" for="Live">@lang('messages.firstname')</label>
          <div class="col-sm-9">
        ...
        <div class="form-group {{($errors->has('username'))? 'has-error' : '' }}">
          ...
          <div class="col-sm-9">
            <input id="username" name="username" value="{{old('username')}}" placeholder="@lang('messages.username')" class="form-control input-md" type="text">
        ...
        <div class="form-group {{($errors->has('email'))? 'has-error' : '' }}">
          ...
          <div class="col-sm-9">
            <input id="email" name="email" value="{{old('email')}}" placeholder="@lang('messages.email')" class="form-control input-md" type="email">
