      ...
      <form method="post" action="" role="form">
            <div class="box-body">
              <div class="form-group">
                <label for="referredMember">firstNameCommission %</label>
              ...
              <div class="form-group hidden">
                <label for="performerSiteMember">@lang('messages.performerSiteMember') %</label>
              ...
              <div class="form-group hidden">
                <label for="otherMember">@lang('messages.otherMember') %</label>
            ...
            <div class="box-footer text-left">
              <button type="submit" class="btn btn-danger btn-sm">@lang('messages.update')</button>
            </div>
          </form>
    </div> <!--user's info end-->
  </div>
