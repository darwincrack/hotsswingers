...
<div class="content">
  <div class="full-container">
    <div class="title"><a href="{{URL('media/image-galleries')}}">@lang('messages.allGalleries')</a></div>
    <div class="panel panel-default">
      <div class="panel-heading"><h4>@lang('messages.gallery'): {{$gallery->name}}</h4></div>
      ...
      <div class="container panel-body" style="width: 100%;">
        ...
        @if(count($images) == 0)
        <div>@lang('messages.imageDoesNotFoundMediaControl')</div>
        @endif
        ...
        <div class="row"> 
            <div class="callout-bubble text-center fade-in-b">
                <h1>{{$gallery->name}} <b>(@lang('messages.privateGallery'))</b> <a href="/media/image-gallery/{{$gallery->id}}/buy" class="btn btn-warning">@lang('messages.buyNow') (<?php echo intval($gallery->price);?> tokens)</a></h1>
