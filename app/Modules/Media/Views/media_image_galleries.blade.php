...
<div class="content"> 
  <div class="full-container">
    <div class="panel panel-default">
      <div class="panel-heading"><h4>@lang('messages.imageGalleries')</h4></div>
      <div class="panel-body row image-galleries">
          ...
          <div class="thumbnail">
            <div class="caption">
              ...
              <p>
                ...
                <a href="{{URL('media/image-gallery/preview/'.$gallery->slug)}}" class="label label-default" rel="tooltip" title="View">@lang('messages.view')</a>
        ...
        <div>@lang('messages.imageNotFoundMediaControl')</div>
        @endif    
      </div>
